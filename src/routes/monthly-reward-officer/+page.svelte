<script lang="ts">
    ...
    let participants = [
        ...
        { id: 5, name: "Michael Jordan", progress: 1, total: 3, status: "in-progress" },
        { id: 6, name: "Lisa Black", progress: 3, total: 3, status: "completed" },
        { id: 7, name: "Tom Holland", progress: 0, total: 3, status: "in-progress" },
                    ...
                    <div class="dropdown-inner"> 
                        {#each months as month}
                            <button 
                                ...
                                on:click={(e) => { e.stopPropagation(); selectMonth(month); }}
                            >
                                {month}
                            </button>
                        {/each}
                ...
                {#each participants as item (item.id)}
                    <div class="card">
                        <div class="card-info">
                            ...
                            <p class="card-progress">Progress: {item.progress}/{item.total}</p>
                        </div>
...
<style>
    ...
    :global(body){ margin: 0; padding: 0; background-color: #111827; color: white; font-family: 'Inter', sans-serif; overflow: hidden; }
    ...
    .glass-header {
        position: absolute; top: 0; left: 0; width: 100%; height: 80px; z-index: 50;
    ...
    .back-btn {
        ...
        display: flex; align-items: center; justify-content: center; color: white; cursor: pointer; transition: 0.2s;
    }

    .back-btn:hover { background: rgba(255, 255, 255, 0.2); }
    .page-title { color: white; font-size: 28px; font-weight: 700; margin: 0; letter-spacing: 1px; text-transform: uppercase; }
    ...
    .month-btn:hover, .month-btn.open { background-color: #F9FAFB; }
    ...
    .content-wrapper { width: 100%; max-width: 400px; margin: 0 auto; padding: 0 20px; box-sizing: border-box; }
    ...
    .card-name { margin: 0; font-size: 14px; font-weight: 600; color: #111827; }
    .card-progress { margin: 0; font-size: 12px; color: #4B5563; font-weight: 500; }
